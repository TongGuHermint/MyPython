...
def get_json(user_id, max_behot_time, as_cp, signature, page_type):
    ...
    url = 'https://www.toutiao.com/api/pc/feed/?category=%E7%BB%84%E5%9B%BE&utm_source=toutiao&max_behot_time={max_behot_time}&tadrequire=true&as={as}&cp={cp}&_signature={signature}'.format(
         page_type=page_type,user_id=user_id,max_behot_time=max_behot_time,signature=signature, **as_cp)
    print(url)
            ...
            try:
                for n, item in enumerate(toutiao_json['data'], 0):
                    ...
                    for j, imgurl in enumerate(imgList, 0):
                        ...
                        path = "D://pachong//toutiao//imgs//"+file_name+".png"
